...
function link_uberlapse_macros {
    if [ -d "${KLIPPER_CONFIG_DIR}" ]; then
        if [ -d "${UBERLAPSE_CONFIG_DIR}" ]; then
            ...
            echo "Linking frame macro file..."
            ln -sf "${SRCDIR}/klipper_macro/camera_provider.cfg" "${UBERLAPSE_CONFIG_DIR}/camera_provider.cfg"
            ...
            echo "Linking parking macro file..."
            ln -sf "${SRCDIR}/klipper_macro/test.cfg" "${UBERLAPSE_CONFIG_DIR}/test.cfg"
        else
