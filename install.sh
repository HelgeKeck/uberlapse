...
function link_uberlapse {
    if [ -d "${KLIPPER_CONFIG_DIR}" ]; then
        ...
        if [ -d "${UBERLAPSE_CONFIG_DIR}" ]; then
            ...
            echo "Linking board macro file..."
            ln -sf "${SRCDIR}/klipper_macro/uberlapse/board.cfg" "${UBERLAPSE_CONFIG_DIR}/board.cfg"
            echo "Linking stepper macro file..."
            ln -sf "${SRCDIR}/klipper_macro/uberlapse/stepper.cfg" "${UBERLAPSE_CONFIG_DIR}/stepper.cfg"
            echo "Linking home macro file..."
            ln -sf "${SRCDIR}/klipper_macro/uberlapse/home.cfg" "${UBERLAPSE_CONFIG_DIR}/home.cfg"
            ...
            ln -sf "${SRCDIR}/klipper_macro/uberlapse/slide.cfg" "${UBERLAPSE_CONFIG_DIR}/slide.cfg"
            echo "Linking pan macro file..."
            ln -sf "${SRCDIR}/klipper_macro/uberlapse/pan.cfg" "${UBERLAPSE_CONFIG_DIR}/pan.cfg"
